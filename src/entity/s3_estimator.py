from src.cloud_storage.aws_storage import SimpleStorageService  # Works for Backblaze too
...
class Proj1Estimator:
    ...
    def __init__(self, bucket_name, model_path):
        ...
        self.s3 = SimpleStorageService()  # Now using Backblaze connection
    ...
    def load_model(self) -> MyModel:
        """
        Load the model from the Backblaze bucket.
        """
